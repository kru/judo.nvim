local Color = require("judo.color")
local M = {}
...
M = {
	...
	gold = Color.new(0xd4af37),
	teal = Color.new(0x5e9a8b),
	gray = Color.new(0x95a99f),
	orange = Color.new(0xcc8c3c),
	light_blue = Color.new(0xb0c9ff)
}
