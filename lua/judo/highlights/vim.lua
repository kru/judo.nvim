...
---Any comment
M.highlights.comment = Highlight.new("Comment", { fg = c.teal, italic = opts.italic.comments })
...
M.highlights.line_number = Highlight.new("LineNr", { fg = c.gray, bg = c.bg })
...
M.highlights.search = Highlight.new("Search", { fg = c.bg, bg = c.blue })
---'incsearch' highlighting; also used for the text replaced with ":s///c"
M.highlights.incremental_search = Highlight.new("IncSearch", { fg = c.fg, bg = c.bg })
...
M.highlights.todo = Highlight.new("Todo", { fg = c.bg, bg = c.gray })
