...
M.highlights.cmp_item_deprecated = Highlight.new("CmpItemAbbrDeprecated", { link = judo_hl.darkest_niagara })
M.highlights.cmp_item_abbr = Highlight.new("CmpItemAbbr", { fg = c.white })
M.highlights.cmp_item_abbr_match = Highlight.new("CmpItemAbbrMatch", { link = judo_hl.yellow_bold })
M.highlights.cmp_item_abbr_match_fuzzy = Highlight.new("CmpItemAbbrMatchFuzzy", { link = judo_hl.brown_bold })
...
M.highlights.cmp_item_kind_field = Highlight.new("CmpItemKindField", { link = judo_hl.niagara })
...
M.highlights.cmp_item_kind_property = Highlight.new("CmpItemKindProperty", { link = judo_hl.dark_niagara })
M.highlights.cmp_item_kind_unit = Highlight.new("CmpItemKindUnit", { link = judo_hl.dark_niagara })
...
M.highlights.cmp_item_kind_snippet = Highlight.new("CmpItemKindSnippet", { link = judo_hl.dark_niagara })
...
M.highlights.cmp_item_kind_struct = Highlight.new("CmpItemKindStruct", { link = judo_hl.niagara })
