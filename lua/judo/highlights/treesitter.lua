...
M.highlights.comment_documentation = Highlight.new("@comment.documentation", { link = judo_hl.green, italic = opts.italic.comments })
...
---Brackets (e.g. `()` / `{}` / `[]`)
M.highlights.punctuation_bracket = Highlight.new("@punctuation.bracket", { link = judo_hl.wisteria })
---Special symbols (e.g. `{}` in string interpolation)
M.highlights.punctuation_special = Highlight.new("@punctuation.special", { link = judo_hl.brown })
...
---Built-in functions
M.highlights.func_builtin = Highlight.new("@function.builtin", { link = judo_hl.orange })
---Function calls
...
---built-in types
M.highlights.type_builtin = Highlight.new("@type.builtin", { link = judo_hl.yellow })
...
-- M.highlights.attribute = Highlight.new("@attribute", { link = judo_hl.brown })
---object and struct fields
M.highlights.field = Highlight.new("@field", { link = judo_hl.niagara })
---similar to `@field`
M.highlights.property = Highlight.new("@property", { link = judo_hl.dark_niagara })
...
M.highlights.variable_builtin = Highlight.new("@variable.builtin", { link = judo_hl.yellow })

---constant identifiers
M.highlights.constant = Highlight.new("@constant", { link = vim_hl.constant })
---built-in constant values
M.highlights.constant_builtin = Highlight.new("@constant.builtin", { link = judo_hl.yellow })
...
M.highlights.text_reference = Highlight.new("@text.reference", { link = judo_hl.yellow_bold })
